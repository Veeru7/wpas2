...
--
Unlock tables;
CREATE DATABASE IF NOT EXISTS `job` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `town` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 7 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

LOCK TABLES `locations` WRITE;
/*!40000 ALTER TABLE `locations` DISABLE KEYS */;
INSERT INTO `locations` VALUES (1,'Northampton'),(2,'Milton Keynes');
...
INSERT INTO `users` VALUES (1, 'admin', 'admin', 'admin', 'test@email.com', '$2y$10$h5bPpSVt1OYgK10Occ/dmu1ZaqNget2GYAcWMoqNyeYNiQABgVg/G', 3, 1);
