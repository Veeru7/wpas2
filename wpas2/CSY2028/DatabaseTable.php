...
class DatabaseTable { 
    ...
    // Function to extract a single record from the specified database table.
    ...
    // Function to fetch all records from the specified database table.
    ...
    // Function to attach a new record into the specified database table.
    ...
    // Function to alter an existing record in the specified database table.
    ...
    // Function to discard a record from the specified database table by specifying the name of the field and a value.
    ...
    // Function to erase a record from the specified database table by entering an id.
    ...
    // Function to add records to the selected database table.
