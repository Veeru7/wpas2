...
class CategoryController {
    ...
    // Function for showing a page listing out all 
    // the categories listed currently in the category table
    ...
    public function editCategorySubmit() {
        ...
        if (isset($this->post['submit'])) {
            ...
            if (count($errors) == 0) {
                ...
                if (empty($this->post['category']['id'])) $this->post['category']['id'] = NULL;
            ...
            // Display the edit form with any generated errors. //save fucntion taught in the class
            else {
                // Update page name accoding to whether $_GET['id'] is set.
                if (isset($this->get['id']))
